    ...
    <div class="card placeholder-card">
      <div class="card-content">
        ...
        <ul class="feature-list">
          <li>{{ t('dashboard.metrics') }}</li>
          <li>{{ t('dashboard.liveFeed') }}</li>
          <li>{{ t('dashboard.roiCurve') }}</li>
        </ul>
      </div>
    </div>
  </div>
...
<style scoped>
.dashboard-view { padding: 1.5rem; max-width: 900px; margin: 0 auto; }
...
.feature-list { margin-top: 0.75rem; padding-left: 1.25rem; color: var(--el-text-color-regular); }
</style>
